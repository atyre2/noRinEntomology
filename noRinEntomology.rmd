...
- Ross Ihaka and Robert Gentleman, U of Auckland wrote a version of the S language, released under a GPL in 1995

## Why RStudio?
- Free ... 
- Reduces errors (Brace matching, syntax highlighting)
- Integrates "knitting" analysis and text

## Can be done elsewhere
- SAS now has a documentation system
- LaTex works with anything
- Less integration; more work
...
## Example: plot of species richness
```{r speciesRichness2, message=FALSE}
xyplot(InsectRich~jitter(NumSp)|Year,data=spRichData)
```
...
> - Read Gandrud (2015)
> - Take my courses! (contact me atyre2@unl.edu)
